...
function carregarOrigem() {
  // funçao para mostrar no elemento 'input' o valor selecionado e definir o valor
...
function calculoSimples() {
  // funçao para calcular o valor do ICMS
  var origemText = origemSelect.options[origemSelect.selectedIndex].text; // obter o valor dentro do elemento 'option'no html
...
function complemento() {
  // funçao para verificar se o elemento 'radio' no html esta preenchido e inserir o novo html
...
function simples() {
  // funçao para verificar se o elemento 'radio' no html esta preenchido e inserir um novo html
...
function carregarDestino() {
  // funçao para mostrar no elemento 'input' o valor selecionado
...
function calculoComplemento() {
  // funçao para calcular o valor do ICMS ST
  var origemText = origemSelect.options[origemSelect.selectedIndex].text; // obter o valor dentro do elemento 'option' no html
